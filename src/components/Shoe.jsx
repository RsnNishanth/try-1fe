...
import { useNavigate } from 'react-router-dom';import useFetch from './Fetch/UseFetch';
...
const Shoe = () => {
  ...
  let { products, error, isLoading } = useFetch("https://try-1-bi0l.onrender.com/products/shoe");
